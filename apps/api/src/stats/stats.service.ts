  ...
  async getProgressHighlight(userId: string, deckId: string) {
    ...
    return {
      ...
      oldReview: {
        ...
        cePointsForts: best.oldLog.cePointsForts,
        cePointsAmeliorer: best.oldLog.cePointsAmeliorer,
        piste: best.oldLog.piste,
        resumeCourt: best.oldLog.resumeCourt,
      ...
      recentReview: {
        ...
        cePointsForts: best.recentLog.cePointsForts,
        cePointsAmeliorer: best.recentLog.cePointsAmeliorer,
        piste: best.recentLog.piste,
        resumeCourt: best.recentLog.resumeCourt,
